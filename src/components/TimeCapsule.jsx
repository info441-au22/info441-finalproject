...
export function TimeCapsule(props) {
  //props constants
  const handleSongLimitAndRecommendationCallback =
    props.handleSongLimitAndRecommendationCallback;
  ...
  const handleAddSongsToPlaylistCallback =
    props.handleAddSongsToPlaylistCallback;
